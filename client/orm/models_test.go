...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/cyannuk/beego_orm/v2/client/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/cyannuk/beego_orm/v2/client/orm.GroupPermissions)"`
}
...
var (
	...
	go get -u github.com/cyannuk/beego_orm/v2/client/orm
	...
	go test -v github.com/cyannuk/beego_orm/v2/client/orm
	...
	go test -v github.com/cyannuk/beego_orm/v2/pgk/orm
